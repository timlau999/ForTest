  ...
  return (
    <div className="order add">
      ...
      {orders.length > 0 ? (
        ...
        <p style={{ fontSize: "18px", color: "#747474" }}>No active orders now</p>
      )}
      <button
        onClick={() => setShowCompletedOrders(!showCompletedOrders)}
        className="completed-orders-button"
      >
      ...
      {showCompletedOrders && (
        <>
          ...
          {completedOrders.length > 0 ? (
            ...
            <p style={{ fontSize: "18px", color: "#747474" }}>No completed orders now</p>
          )}
        </>
      )}
    </div>
