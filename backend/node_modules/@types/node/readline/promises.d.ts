...
declare module "readline/promises" {
    ...
    class Interface extends _Interface {
         ...
         *
         * ```js
         * const answer = await rl.question('What is your favorite menuItem? ');
         * console.log(`Oh, so your favorite menuItem is ${answer}`);
         * ```
         *
         ...
         *   console.log('The menuItem question timed out');
         * }, { once: true });
         *
         * const answer = await rl.question('What is your favorite menuItem? ', { signal });
         * console.log(`Oh, so your favorite menuItem is ${answer}`);
         * ```
         * @since v17.0.0
